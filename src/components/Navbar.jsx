            ...
            >
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="flex flex-col gap-1.5 w-4">
                  <span
                    className={`w-4 h-0.5 bg-gray-900 rounded-full transition-all duration-300 ${open ? "rotate-45 translate-y-2" : ""}`}
                  ></span>
                  <span
                    className={`w-4 h-0.5 bg-gray-900 rounded-full transition-all duration-300 ${open ? "opacity-0" : ""}`}
                  ></span>
                  <span
                    className={`w-4 h-0.5 bg-gray-900 rounded-full transition-all duration-300 ${open ? "-rotate-45 -translate-y-2" : ""}`}
                  ></span>
